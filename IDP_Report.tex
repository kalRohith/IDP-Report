...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{AquaTrack: Prototype-Based Multimodal AI for Context-Aware Dehydration Prediction}	
\subCode{XX367P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Kalianpur Rohith}
\stuUSNA{1RV23CS109}
\stuNameB{Lochan N S}
\stuUSNB{1RV23CS120}
\stuNameC{Harshith Krishna K}
\stuUSNC{1RV23BT027}
\stuNameD{N Sivakhami}
\stuUSND{1RV23BT037}
...
\guideNameA{Ms. Sujata Priyambada Mishra}
...
%Chapter 6
\input{./Chapter6/chapter6-conclusion}
