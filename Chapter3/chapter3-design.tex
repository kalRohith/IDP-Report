...
The final fused dehydration score $F$ is computed as a weighted combination of the independent pipeline outputs,showing biomarker-driven versus context-driven evidence:
\begin{equation}
