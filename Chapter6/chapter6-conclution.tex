...
\begin{itemize}
\item Evaluated the role of hydrogels as flexible and biocompatible matrices for wearable biosensing.
\item Synthesized sodium alginate and PVA hydrogels and compared their practical outcomes.
...
\item Optimized multiple machine learning classifiers using cross-validation and F1 score metrics.
