...
\begin{itemize}
\item Evaluated the role of hydrogels as flexible and biocompatible matrices for wearable biosensing and prototyping in dehydration detection.
\item Synthesized sodium alginate and PVA hydrogels and compared their practical outcomes in dehydration physiology.
\item Studied urease-based colorimetric detection for urea-rich artificial sweat.
\item Implemented a robust preprocessing workflow involving imputation, winsorization, and robust scaling.
\item Designed domain-informed composite features for enhanced dehydration prediction.
\item Optimized multiple machine learning classifiers using various evaluation metrics.
\item Developed a weighted biomarker-context fusion strategy for interpretable mobile health monitoring purposes.
\end{itemize}
