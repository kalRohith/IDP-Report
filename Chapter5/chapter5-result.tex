...
PVA hydrogel trials were not successful because the hydrogel did not cross-link adequately despite multiple freeze-thaw cycles. Possible reasons include insufficient PVA concentration, temperature variation during freezing and thawing, and weak crystallite formation. Since sodium alginate produced more reliable patches, it was selected for the final prototype. The resulting PVA samples remained semi-liquid and lacked the structural integrity required for a wearable application. Furthermore, the enzymatic activity of urease may have been compromised during the repeated temperature fluctuations, leading to inconsistent colorimetric responses. Consequently, the sodium alginate route was prioritized for its superior cross-linking efficiency and chemical stability.
...
\small
\centering
\caption{Distribution of weighted fusion score F across the three derived risk classes.}
\label{tab:fusion-score-dist}
\begin{tabular}{lccccc}
\toprule
\textbf{Risk Class} & \textbf{n} & \textbf{Mean F} & \textbf{Std F} & \textbf{Min F} & \textbf{Max F} \\
\midrule
Low & 30 & 0.203 & \textit{[TBP]} & 0.096 & 0.243 \\
Medium & 30 & 0.295 & \textit{[TBP]} & 0.247 & 0.351 \\
High & 30 & 0.471 & \textit{[TBP]} & 0.354 & 0.744 \\
\bottomrule
\end{tabular}
\end{table}
